...
var PasswordFieldView = function (_React$Component) {
  ...
  _createClass(PasswordFieldView, [{
    ...
    key: '_onInputOneBlur',
    value: function _onInputOneBlur() {
      var inputOne = this.refs.inputOne.getValue().trim();
    ...
    key: '_onInputTwoBlur',
    value: function _onInputTwoBlur() {
      var inputTwo = this.refs.inputTwo.getValue().trim();
    ...
    key: '_submitPwd',
    value: function _submitPwd(index) {
      var inputOne = this.refs.inputOne.getValue().trim();
      var inputTwo = this.refs.inputTwo.getValue().trim();
      var one = false;
      var two = false;
